...
config = {
    ...
    'dag_id_2': {'schedule_interval': timedelta(minutes=20), 'start_date': datetime(2020,1,16), 'max_active_runs': 1},
    'dag_id_3': {'schedule_interval': timedelta(minutes=25), 'start_date': datetime(2020,1,16), 'max_active_runs': 1}
}
